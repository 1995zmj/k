...
{
    /*------ 动态加载目录 ------*/
    public static readonly AUDIO_DIR = "audio/MP3_";
    public static readonly CONFIG_FILE_DIR = "config/JSON_";
    public static readonly PREFAB_UI_DIR = "prefab/ui/PF_";
    public static readonly PREFAB_POOL_DIR = "prefab/pool/PF_";
